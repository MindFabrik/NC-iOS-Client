...
- (void)reloadForm
{
    ...
    //Change-MindFabrik-Start
     if ([NCBrandOptions sharedInstance].mindfabrik_force_lockfeature) {
         NSLog(@"[MFLOG] PINStatus %ld", mfSetPINStatus);
         if (mfSetPINStatus == 2) {
            NSLog(@"[MFLOG] Switch View to Files");
            [self.parentViewController.tabBarController setSelectedIndex:k_tabBarApplicationIndexFile];
            [self.tabBarController setSelectedIndex:k_tabBarApplicationIndexFile];
             mfSetPINStatus = 0;
        }
    }
    //Change-MindFabrik-End
    ...
    switch (aViewController.type) {
        ...
        case BKPasscodeViewControllerNewPasscodeType: {
            ...
            if ([NCBrandOptions sharedInstance].mindfabrik_force_lockfeature) {
                ...
                // Set PINStatus
                NSLog(@"[MFLOG] set PIN Status to 2");
                mfSetPINStatus = 2;
            }
            //Change-MindFabrik-End
